...
namespace frc973 {
class PatchedTimedRobot : public frc::IterativeRobotBase {
public:
    ...
    /**
     * Constructor for PatchedTimedRobot.
     *
     * @deprecated use unit safe constructor instead.
     * PatchedTimedRobot(units::second_t period = kDefaultPeriod)
     *
     * @param period Period in seconds.
     */
    WPI_DEPRECATED("Use constructor with unit-safety instead.")
    explicit PatchedTimedRobot(double period);
     ...
     * @param period Period.
     */
    explicit PatchedTimedRobot(units::second_t period = kDefaultPeriod);

    ~PatchedTimedRobot() override;

    PatchedTimedRobot(PatchedTimedRobot&&) = default;
    PatchedTimedRobot& operator=(PatchedTimedRobot&&) = default;

    /**
     * Add a callback to run at a specific period with a starting time offset.
     *
     * This is scheduled on PatchedTimedRobot's Notifier, so PatchedTimedRobot and the callback
