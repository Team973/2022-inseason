...
SetFlywheelRPMCommand::SetFlywheelRPMCommand(Shooter *shooter, double setpoint, u_int32_t targetTime)
        : m_shooter(shooter), m_setpoint(setpoint), m_targetTime(targetTime) {
}
